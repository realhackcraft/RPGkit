...
public class LDtk {
    ...
    public String getBackupRelPath() { return backupRelPath; }
    @JsonProperty("backupRelPath")
    public void setBackupRelPath(String value) { this.backupRelPath = value; }
    ...
    public LdtkCustomCommand[] getCustomCommands() { return customCommands; }
    @JsonProperty("customCommands")
    public void setCustomCommands(LdtkCustomCommand[] value) { this.customCommands = value; }
    ...
    public String getDummyWorldIid() { return dummyWorldIid; }
    @JsonProperty("dummyWorldIid")
    public void setDummyWorldIid(String value) { this.dummyWorldIid = value; }

    /**
     * If TRUE, the exported PNGs will include the level background (color or image).
     */
    @JsonProperty("exportLevelBg")
    public boolean getExportLevelBg() { return exportLevelBg; }
    @JsonProperty("exportLevelBg")
    public void setExportLevelBg(boolean value) { this.exportLevelBg = value; }
     ...
     */
    @JsonProperty("toc")
    public LdtkTableOfContentEntry[] getToc() { return toc; }
    @JsonProperty("toc")
    public void setToc(LdtkTableOfContentEntry[] value) { this.toc = value; }
