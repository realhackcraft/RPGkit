...
public class TilesetDefinition {
    ...
    @JsonProperty("__cHei")
    public void setCHei(long value) {
        this.cHei = value;
    }
    ...
    @JsonProperty("__cWid")
    public void setCWid(long value) {
        this.cWid = value;
    }
    ...
    @JsonProperty("cachedPixelData")
    public void setCachedPixelData(Map<String, Object> value) {
        this.cachedPixelData = value;
    }
    ...
    @JsonProperty("customData")
    public void setCustomData(TileCustomMetadata[] value) {
    ...
    @JsonProperty("embedAtlas")
    public void setEmbedAtlas(EmbedAtlas value) {
        this.embedAtlas = value;
    }
    ...
    @JsonProperty("enumTags")
    public void setEnumTags(EnumTagValue[] value) {
        this.enumTags = value;
    }
    ...
    @JsonProperty("relPath")
    public void setRelPath(String value) {
        this.relPath = value;
    }
    ...
    @JsonProperty("savedSelections")
    public void setSavedSelections(Map<String, Object>[] value) {
        this.savedSelections = value;
    }
    ...
    public Long getTagsSourceEnumUid() {
        return tagsSourceEnumUid;
    }

    @JsonProperty("tagsSourceEnumUid")
    public void setTagsSourceEnumUid(Long value) {
        this.tagsSourceEnumUid = value;
    }

    @JsonProperty("tileGridSize")
    public long getTileGridSize() {
        return tileGridSize;
    }

    @JsonProperty("tileGridSize")
    public void setTileGridSize(long value) {
