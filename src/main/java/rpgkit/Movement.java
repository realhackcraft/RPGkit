...
public class Movement {
  ...
  public static void computeMovements(KeyHandler keyHandler, double delta) {
    ...
    boolean[] keys = { keyHandler.isKeyPressed(VK_UP) || keyHandler.isKeyPressed(VK_W), keyHandler.isKeyPressed(
        VK_DOWN) || keyHandler.isKeyPressed(VK_S),
        keyHandler.isKeyPressed(
            VK_LEFT) || keyHandler.isKeyPressed(VK_A),
        keyHandler.isKeyPressed(VK_RIGHT) || keyHandler.isKeyPressed(
            VK_D) };

    Rectangle[] playerCollisionBoxes = { (Rectangle) player.hitbox.clone(), (Rectangle) player.hitbox.clone(),
        (Rectangle) player.hitbox.clone(), (Rectangle) player.hitbox.clone() };
