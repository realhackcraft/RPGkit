...
public class ForcedRefs {
    ...
    private IntGridValueGroupDefinition intGridValueGroupDef;
    ...
    public LdtkCustomCommand getCustomCommand() { return customCommand; }
    @JsonProperty("CustomCommand")
    public void setCustomCommand(LdtkCustomCommand value) { this.customCommand = value; }
    ...
    public ReferenceToAnEntityInstance getEntityReferenceInfos() { return entityReferenceInfos; }
    @JsonProperty("EntityReferenceInfos")
    public void setEntityReferenceInfos(ReferenceToAnEntityInstance value) { this.entityReferenceInfos = value; }
    ...
    @JsonProperty("GridPoint")
    public void setGridPoint(GridPoint value) { this.gridPoint = value; }
    ...
    public IntGridValueGroupDefinition getIntGridValueGroupDef() { return intGridValueGroupDef; }
    @JsonProperty("IntGridValueGroupDef")
    public void setIntGridValueGroupDef(IntGridValueGroupDefinition value) { this.intGridValueGroupDef = value; }
    ...
    public LdtkTableOfContentEntry getTableOfContentEntry() { return tableOfContentEntry; }
    @JsonProperty("TableOfContentEntry")
    public void setTableOfContentEntry(LdtkTableOfContentEntry value) { this.tableOfContentEntry = value; }
