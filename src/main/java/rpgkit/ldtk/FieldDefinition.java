...
public class FieldDefinition {
    ...
    public Long getAllowedRefsEntityUid() { return allowedRefsEntityUid; }
    @JsonProperty("allowedRefsEntityUid")
    public void setAllowedRefsEntityUid(Long value) { this.allowedRefsEntityUid = value; }
    ...
    public String getEditorDisplayColor() { return editorDisplayColor; }
    @JsonProperty("editorDisplayColor")
    public void setEditorDisplayColor(String value) { this.editorDisplayColor = value; }
    ...
    public double getEditorDisplayScale() { return editorDisplayScale; }
    @JsonProperty("editorDisplayScale")
    public void setEditorDisplayScale(double value) { this.editorDisplayScale = value; }

    /**
     * Possible values: `ZigZag`, `StraightArrow`, `CurvedArrow`, `ArrowsLine`, `DashedLine`
     */
    @JsonProperty("editorLinkStyle")
    public EditorLinkStyle getEditorLinkStyle() { return editorLinkStyle; }
    @JsonProperty("editorLinkStyle")
    public void setEditorLinkStyle(EditorLinkStyle value) { this.editorLinkStyle = value; }

    @JsonProperty("editorShowInWorld")
    public boolean getEditorShowInWorld() { return editorShowInWorld; }
    @JsonProperty("editorShowInWorld")
    public void setEditorShowInWorld(boolean value) { this.editorShowInWorld = value; }
