...
public class LayerDefinition {
    ...
    private IntGridValueGroupDefinition[] intGridValuesGroups;
    ...
    public boolean getCanSelectWhenInactive() { return canSelectWhenInactive; }
    @JsonProperty("canSelectWhenInactive")
    public void setCanSelectWhenInactive(boolean value) { this.canSelectWhenInactive = value; }
    ...
    public IntGridValueGroupDefinition[] getIntGridValuesGroups() { return intGridValuesGroups; }
    @JsonProperty("intGridValuesGroups")
    public void setIntGridValuesGroups(IntGridValueGroupDefinition[] value) { this.intGridValuesGroups = value; }
    ...
    public boolean getRenderInWorldView() { return renderInWorldView; }
    @JsonProperty("renderInWorldView")
    public void setRenderInWorldView(boolean value) { this.renderInWorldView = value; }
    ...
    @JsonProperty("uiColor")
    public void setUIColor(String value) { this.uiColor = value; }
