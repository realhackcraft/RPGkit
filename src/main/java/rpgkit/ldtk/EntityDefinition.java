...
public class EntityDefinition {
    ...
    @JsonProperty("exportToToc")
    public void setExportToToc(boolean value) {
        this.exportToToc = value;
    }
    ...
    @JsonProperty("fieldDefs")
    public void setFieldDefs(FieldDefinition[] value) {
        this.fieldDefs = value;
    }
    ...
    @JsonProperty("limitBehavior")
    public void setLimitBehavior(LimitBehavior value) {
        this.limitBehavior = value;
    }
    ...
    @JsonProperty("limitScope")
    public void setLimitScope(LimitScope value) {
        this.limitScope = value;
    }
    ...
    @JsonProperty("nineSliceBorders")
    public void setNineSliceBorders(long[] value) {
        this.nineSliceBorders = value;
    }
    ...
    @JsonProperty("resizableX")
    public void setResizableX(boolean value) {
    ...
    @JsonProperty("resizableY")
    public void setResizableY(boolean value) {
    ...
    @JsonProperty("tileOpacity")
    public void setTileOpacity(double value) {
    ...
    @JsonProperty("tileRect")
    public void setTileRect(TilesetRectangle value) {
        this.tileRect = value;
    }
    ...
    @JsonProperty("tileRenderMode")
    public void setTileRenderMode(TileRenderMode value) {
        this.tileRenderMode = value;
    }
    ...
    @JsonProperty("tilesetId")
    public void setTilesetID(Long value) {
