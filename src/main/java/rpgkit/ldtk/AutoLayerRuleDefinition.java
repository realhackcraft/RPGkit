...
public class AutoLayerRuleDefinition {
    ...
    @JsonProperty("breakOnMatch")
    public void setBreakOnMatch(boolean value) {
        this.breakOnMatch = value;
    }
    ...
    @JsonProperty("checker")
    public void setChecker(Checker value) {
        this.checker = value;
    }
    ...
    public Long getOutOfBoundsValue() {
        return outOfBoundsValue;
    }

    @JsonProperty("outOfBoundsValue")
    public void setOutOfBoundsValue(Long value) {
        this.outOfBoundsValue = value;
    }
    ...
    @JsonProperty("perlinActive")
    public void setPerlinActive(boolean value) {
        this.perlinActive = value;
    }
    ...
    @JsonProperty("perlinOctaves")
    public void setPerlinOctaves(double value) {
        this.perlinOctaves = value;
    }
    ...
    @JsonProperty("perlinScale")
    public void setPerlinScale(double value) {
    ...
    @JsonProperty("perlinSeed")
    public void setPerlinSeed(double value) {
        this.perlinSeed = value;
    }
    ...
    public long getTileRandomXMax() {
        return tileRandomXMax;
    }

    @JsonProperty("tileRandomXMax")
    public void setTileRandomXMax(long value) {
        this.tileRandomXMax = value;
    }
    ...
    public long getTileRandomXMin() {
        return tileRandomXMin;
    }

    @JsonProperty("tileRandomXMin")
    public void setTileRandomXMin(long value) {
        this.tileRandomXMin = value;
    }
    ...
    public long getTileRandomYMax() {
        return tileRandomYMax;
    }

    @JsonProperty("tileRandomYMax")
    public void setTileRandomYMax(long value) {
        this.tileRandomYMax = value;
    }
    ...
    public long getTileRandomYMin() {
        return tileRandomYMin;
    }

    @JsonProperty("tileRandomYMin")
    public void setTileRandomYMin(long value) {
        this.tileRandomYMin = value;
    }
    ...
    public long getTileXOffset() {
        return tileXOffset;
    }

    @JsonProperty("tileXOffset")
    public void setTileXOffset(long value) {
        this.tileXOffset = value;
    }
    ...
    public long getTileYOffset() {
        return tileYOffset;
    }

    @JsonProperty("tileYOffset")
    public void setTileYOffset(long value) {
        this.tileYOffset = value;
    }
    ...
    public long getXModulo() {
        return xModulo;
    }

    @JsonProperty("xModulo")
    public void setXModulo(long value) {
        this.xModulo = value;
    }
    ...
    @JsonProperty("xOffset")
    public void setXOffset(long value) {
        this.xOffset = value;
    }
    ...
    public long getYModulo() {
        return yModulo;
    }

    @JsonProperty("yModulo")
    public void setYModulo(long value) {
        this.yModulo = value;
    }
    ...
    @JsonProperty("yOffset")
    public void setYOffset(long value) {
        this.yOffset = value;
    }
}
