...
public class ImageUtils {
  /**
   * Flips the given BufferedImage image horizontally. The resulting image is a
   * mirror image, where the left side is on the right and vice versa.
   *
  ...
  /**
   * Flips the given BufferedImage image vertically. The resulting image is a
   * mirror image, where the top is on the bottom and vice versa.
   *
  ...
  /**
   * Flips the given BufferedImage image horizontally and vertically. The
   * resulting image is a mirrored image where the left is on the right and vice
   * versa and the top is on the bottom and vice versa.
   *
   * @param image the BufferedImage to be flipped horizontally and vertically
   * @return the resulting BufferedImage containing the horizontally and
