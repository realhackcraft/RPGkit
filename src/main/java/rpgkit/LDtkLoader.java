...
public class LDtkLoader {
  ...
  public Player loadPlayer(LDtk ldtk, EntityInstance entity, LayerInstance layer, Level level,
  ...
  private void addAutoTile(TileProperties properties, TileInstance tile, TileSet tileset, Level targetLevel,
   ...
   */
  public void addTile(TileProperties properties, TileInstance tile, TileSet tileset, Level targetLevel,
      TileManager tileManager) {
    try {
      if (properties != null && properties.getInteraction() != null) {
        Tile tile1 = RPGKit.getInstance().interactableLoader.loadInteractable(properties.getInteraction().toLowerCase(),
